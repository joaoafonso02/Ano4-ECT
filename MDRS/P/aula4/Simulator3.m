...
for i = 1:n
    tmp = unifrnd(0, 0.020); % convert to seconds between 16 milliseconds and 24 milliseconds
    EventList = [EventList; ARRIVAL, tmp, randi([110, 130]), tmp, VOIP]; % size uniformly distributed between 110 Bytes and 130 Bytes,
end
    ...
    switch Event
        case ARRIVAL                     % If first event is an ARRIVAL
            if (PacketType == DATA)      % Data Packet
                ...
                tmp = Clock + unifrnd(16/1000, 24/1000);
